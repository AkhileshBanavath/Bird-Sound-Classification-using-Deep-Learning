...
def prediction(audio_file):
    ...
    with open('/content/drive/MyDrive/major-2/Bird-Sound-Classification-using-Deep-Learning-main/pred.json', mode='r') as f:
    ...
    model = tf.keras.models.load_model('/content/drive/MyDrive/major-2/Bird-Sound-Classification-using-Deep-Learning-main/Model.h5')
    ...
    # Display the Image
    image_path = os.path.join('/content/drive/MyDrive/major-2/Bird-Sound-Classification-using-Deep-Learning-main/Inference_Images', f'{predicted_class}.jpg')
